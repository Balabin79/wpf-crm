...
namespace B6CRM.Services.SmsServices.SmscService
{
    public class SMSC
    {
        // Константы с параметрами отправки
        const string SMSC_LOGIN = "Alex657913";         // логин клиента
        const string SMSC_PASSWORD = "856c0463838c52e34fbb6dcc965224afddb587b8";    // пароль или MD5-хеш пароля в нижнем регистре
