...
using Dental.Services.Smsc.Parsing;
...
namespace Dental.Services.Smsc
{
    public class Sender
    {
        ...
        private bool SMSC_HTTPS = false;              // использовать HTTPS протокол
        private string SMSC_CHARSET = "utf-8";        // кодировка сообщения (windows-1251 или koi8-r), по умолчанию используется utf-8
        private bool SMSC_DEBUG = false;              // флаг отладки

        // Константы для отправки SMS по SMTP
        private string SMTP_FROM = "api@smsc.ru";     // e-mail адрес отправителя
        private string SMTP_SERVER = "send.smsc.ru";  // адрес smtp сервера
        private string SMTP_LOGIN = "";               // логин для smtp сервера
        private string SMTP_PASSWORD = "";            // пароль для smtp сервера
