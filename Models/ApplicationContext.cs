...
namespace B6CRM.Models
{
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Channel>().HasData(new Channel { Id = 2, Guid = "IUAoR5QCigKWIXeyDsWa", CreatedAt = 1649579905, UpdatedAt = 1649579905, Name = "WhatsApp", ProstoSms = 1, SmsCenter = 0 });

            modelBuilder.Entity<Channel>().HasData(new Channel { Id = 3, Guid = "IUAoR5QCigKWIXeyDs01", CreatedAt = 1649579905, UpdatedAt = 1649579905, Name = "Viber", ProstoSms = 0, SmsCenter = 1 });

            modelBuilder.Entity<Channel>().HasData(new Channel { Id = 4, Guid = "IUAoR5QCigKWIXeyDs02", CreatedAt = 1649579905, UpdatedAt = 1649579905, Name = "Telegram", ProstoSms = 1, SmsCenter = 0 });

            modelBuilder.Entity<Channel>().HasData(new Channel { Id = 5, Guid = "IUAoR5QCigKWIXeyDs03", CreatedAt = 1649579905, UpdatedAt = 1649579905, Name = "VK", ProstoSms = 1, SmsCenter = 1 });
