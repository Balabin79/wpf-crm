...
namespace Dental.Models
{
    ...
    class WageRateForEmployments : AbstractBaseModel, IDataErrorInfo
    {
        ...
        public object Clone()
        {
            return new WageRateForEmployments
            {
                Id = this.Id,
                Name = this.Name,
                Guid = this.Guid,
        ...
        public WageRateForEmployments Copy(WageRateForEmployments model)
        {
            model.Id = this.Id;
        ...
        public override bool Equals(object other)
        {
            ...
            return this.Equals(other as WageRateForEmployments);
        }
        public bool Equals(WageRateForEmployments other)
        {
            NotIsChanges = true;
            if (other == null)
                return false;
